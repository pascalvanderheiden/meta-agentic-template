...
9. **Leverage project authoring standards (standing directive).** Every spawn that creates or edits a skill, agent, instruction, prompt, or hook MUST include the matching project guideline in the spawn prompt and require the agent to read and follow it before writing:
   - `**/skills/**/SKILL.md` → `.github/instructions/agent-skills.instructions.md`
   - `**/*.agent.md` → `.github/instructions/agents.instructions.md`
   - `**/*.instructions.md` → `.github/instructions/instructions.instructions.md`
...
|-----------|---------|----------|
| Architecture, meta-cognition design | Neo | — |
| Prompt engineering, agentic flows | Morpheus | — |
| Scaffolding, patterns, codegen | Trinity | — |
| Reasoning, context, decisions | Oracle | — |
| GitHub Copilot, tooling, CI/CD | Tank | — |
